...
package com.kindlebird.tools.kit;
...
public class PathKit {
	...
	private static String Project="liber";
	...
	public static String getCanonicalPath(){
		...
		//URL url = PathKit.class.getClass().getClassLoader().getResource("");
		String url=getRootClassPath();
		int i=url.toString().indexOf(Project);
		String canonicalPath=url.toString().substring(0,i)+Project+File.separator;

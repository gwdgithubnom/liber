...
"""
for this method update at 20160913 to add new code to support to create image-b.xml
...
def start_imagexml_builder(source=resource_manager.Properties.getDefaultOperationFold(),
    ...
    rmfile()
    log.info("starting to init dataset from "+str(source)+" to running create image-b.xml module.")
